...
public class Board {
	...
	public static void main(String[] args){
		...
		ImageLabel.setIcon(new ImageIcon("cluedo board.jpg")); //has to be image_label
		Box box = Box.createVerticalBox();
        		// add Frames to specified area
		
		GridLayoutManager MyGrid = new GridLayoutManager();
//		box.add(MyGrid);
		...
		Container Content = MyGrid.getContentPane();
		TopPanel.setTopComponent(Content);
